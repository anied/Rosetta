"""
Extends CSV library to allow unicode.
Based almost entirely off code found here:
...
class DictWriter:
    """
    CSV DictWriter which will write given rows to CSV file "f",
    which is encoded in the given encoding.
    """
